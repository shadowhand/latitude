...
class UpdateQueryTest extends TestCase
{
    public function testUpdate()
    {
        ...
        $update = UpdateQuery::make($table, $map)->where(Conditions::make('username = ?', 'jsmith'))->returning(['updated_at']);
        $this->assertSame('UPDATE users SET username = ? WHERE username = ? RETURNING updated_at', $update->sql());
