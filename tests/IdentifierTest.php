...
class IdentifierTest extends TestCase
{
    ...
    {
        $identifiers = ['users u', 'users.id userId'];
        $this->assertSame(\array_map([$this->identifier, 'escapeAlias'], $identifiers), $this->identifier->allAliases($identifiers));
    }
    /**
     * @dataProvider dataInvalid
     */
    public function testInvalid($invalid)
    {
    ...
    {
        return ['cannot start with a digit' => ['0col'], 'cannot contain invalid characters' => ['bad!']];
    }
