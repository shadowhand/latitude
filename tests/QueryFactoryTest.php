...
class QueryFactoryTest extends TestCase
{
    ...
    {
        return ['MySQL' => ['mysql', SelectQuery::class, InsertQuery::class, UpdateQuery::class, DeleteQuery::class, MySQL\Identifier::class], 'Postgres' => ['pgsql', SelectQuery::class, Postgres\InsertQuery::class, Postgres\UpdateQuery::class, Postgres\DeleteQuery::class, Common\Identifier::class], 'SQL Server' => ['sqlsrv', SelectQuery::class, InsertQuery::class, UpdateQuery::class, DeleteQuery::class, SqlServer\Identifier::class], 'SQLite' => ['sqlite', SelectQuery::class, InsertQuery::class, UpdateQuery::class, DeleteQuery::class, Common\Identifier::class]];
    }
