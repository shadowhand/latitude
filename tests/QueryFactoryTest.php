...
class QueryFactoryTest extends TestCase
{
     ...
     */
    public function testFactory($engine, $selectClass, $insertClass, $updateClass, $deleteClass, $identifierClass)
    {
    ...
    public function dataFactory()
    {
        return [
            ...
            'MySQL' => ['mysql', SelectQuery::class, InsertQuery::class, MySQL\UpdateQuery::class, MySQL\DeleteQuery::class, MySQL\Identifier::class],
            'Postgres' => ['pgsql', SelectQuery::class, Postgres\InsertQuery::class, Postgres\UpdateQuery::class, Postgres\DeleteQuery::class, Common\Identifier::class],
            'SQL Server' => ['sqlsrv', SelectQuery::class, InsertQuery::class, UpdateQuery::class, DeleteQuery::class, SqlServer\Identifier::class],
            'SQLite' => ['sqlite', SelectQuery::class, InsertQuery::class, UpdateQuery::class, DeleteQuery::class, Common\Identifier::class],
            'Common' => ['', SelectQuery::class, InsertQuery::class, UpdateQuery::class, DeleteQuery::class, Common\Identifier::class],
        ];
    }
